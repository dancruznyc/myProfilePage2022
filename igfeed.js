(function exportInstafeed(root, factory) {
  ...
  function Instafeed(options) {
    ...
    var opts = {
      ...
      target: "instafeed",
      template:
        '<a href="{{link}}"><img title="{{caption}}" src="{{image}}" class="ig-imgs" /></a>',
      templateBoundaries: ["{{", "}}"],
      transform: null,
    };
...
var userFeed = new Instafeed({
  ...
  accessToken:
    "IGQVJWRUdNSzlwM1J2eXZAEcmdxaWhEVGxUTnNYM2JRYVJpQ3hiLUJicVNVa2FxVTduakYzZAWZAKdnlpQ214VlhORnFud1AxYVlWVDI1ZA2NmbFl5U19qYm1mYzdudWoxZA3pwRXQ4eUpqMnl5ZAjZAoRlFhRQZDZD",
});
userFeed.run();
